            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.8/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.8/js/demo.js"></script>
</body>
</html>
