                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs"><?= $_SESSION['hn_username'] ?></span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    <?= $_SESSION['hn_username'] ?> - <?= $_SESSION['hn_level'] ?>
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="../controllers/AuthController.php?func_name=logout" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
