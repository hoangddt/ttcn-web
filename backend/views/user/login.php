...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="../controllers/AuthController.php?func_name=login" method="post">
            <div class="form-group">
                <?php
                if (!empty($errors) && !empty($errors['error'])) {
                    echo "<div class='has-error alert-danger form-control'>$errors[error]</div>";
                } ?>
            </div>
