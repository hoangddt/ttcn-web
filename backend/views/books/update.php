...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-default">
            <div class="box-body">
                <form method="post" action="../controllers/BooksController.php?func_name=update&id=<?=$book['id'] ?>">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" name="amount" class="form-control" value="<?= $book['amount'] ?>">
                                <?php
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" rows="6"><?= $book['description'] ?></textarea>
                            </div>
                        </div>
                        <!-- /.col -->
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <textarea name="details" id="details" rows="20" cols="80">
                            <?= $book['details'] ?>
                        </textarea>
                        </div>
                    </div>
